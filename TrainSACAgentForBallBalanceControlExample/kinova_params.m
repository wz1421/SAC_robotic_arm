...
% Installation of Robotics System Toolbox Robot Library Data is required.
...
if spkgInstalled
    ...
    meshPath = fullfile(spkgroot,'toolbox','robotics','supportpackages', ...
        ...
        'gen3','7dof','meshes');
    addpath(meshPath);
    set_param("rlKinovaBallBalance/Kinova Ball Balance/7 DOF Manipulator","VChoice","on");
else
    set_param("rlKinovaBallBalance/Kinova Ball Balance/7 DOF Manipulator","VChoice","off");
end
